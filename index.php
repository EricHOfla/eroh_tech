...
?>
                    ...
                    <div class="col-12 col-md-5">
                        ...
                        <div class="welcome-thumb-wrapper mt-5 mt-md-0">
                            <span class="welcome-thumb-1">
                                <img class="welcome-animation d-block ml-auto" src="assets/img/welcome/welcomee.png" alt="" style="width: 400px">
                            </span>
        ...
        <section class="section promo-area ptb_100">
            <div class="container">
                ...
                <?php
				   $q="SELECT * FROM  why_us ORDER BY id ASC LIMIT 3";
...
<div class='single-case-studies'>
    ...
    <a href='portdetail.php?id=$id'>
        <img src='admin/uploads/portfolio/$ufile' alt=''>
    </a>
...
<div class='reviewer media mt-3'>
    ...
    <div class='reviewer-thumb'>
        <img class='avatar-lg radius-100' src='admin/uploads/testimony/$ufile' alt='img'>
    </div>
    <!-- Reviewer Media -->
...
$recipient="ericofla1@gmail.com";

$formcontent="NAME:$name \n EMAIL: $email  \n PHONE: $phone  \n MESSAGE: $message";

$subject = "New Enquiry from EROH TEch Website";
$mailheader = "From: noreply@erohtech.com \r\n";
